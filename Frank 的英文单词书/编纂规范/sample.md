...
>
> **模块顺序（有则写，无则整节省略）**：`[义]` → `[态]` → `[例]` → `[源]` → `[族]` → `[搭]` → `[近]` → `[反]` → `[辨]` → `[联]` → `[记]`
>
> **`[联]`**（联想词）：由本词**联想到的其他英语词**（扩展词汇网），格式 `英文 中文, …`；**不是**近义辨析（`[近]`），**不是**词源亲属（`[族]`），**不是**记法窍门（`[记]`）。标准示范见下节 *limp*。

## 联想词样例：limp

> **适用**：展示 `[联]` 的标准写法；详写/中详中，凡能带动一片语义场的词宜写 `[联]`，宜**多列**

**limp**
英/美 /lɪmp/
adj. 跛的；无力的；松软的
v. 跛行；拖沓地进行
[义] Walking with difficulty because one leg is injured or weak; lacking stiffness or energy. 本义跛行、无力；引申指进展**疲软**（the economy limped along 经济萎靡前行）。形容词可指肢体（a limp wrist 无力的手腕），亦可指物体**软塌**（limp lettuce 蔫了的生菜）。
[例] ① He **limped** off the field after twisting his ankle. 他扭伤脚踝后**一瘸一拐**走下场地。 ② Sales **limped** along in the first quarter. 第一季度销售**萎靡不振**。
[联] lifeless 无生命的, crippled 残废的/跛腿的, bruised 青肿的, wobbly 摆动的, sluggish 迟缓的, soggy 浸水的, stiff 僵硬的, mushy 糊状的, crumpled 皱的, numb 麻木的, sickly 病弱的, weary 疲惫的, frail 虚弱的, drooping 耷拉的, sagging 下坠的
[记] 动词规则变化 limp / limped / limped / limping；名词 a limp 指跛行姿态。limp 与 lymph（淋巴）**不同词**。

## 详写样例：melancholy

> **适用**：易混、文化特异、宜记词源，约全书 15%

**melancholy**
英 /ˈmelənkəli/ 美 /ˈmelənkɑːli/
n. 忧郁；忧郁症
adj. 忧郁的
[义] A deep, pensive sadness, typically without obvious cause; sombre in tone. 核心义：深沉、持久、常无明确外因的悲伤，带内省色彩——不是痛哭的 grief，而是「安静地沉下去」。可含审美意味（autumn melancholy 秋日惆怅）。**不是**日常「不开心」的简单说法；雨天、落叶、怀旧易唤起此词。勿与 clinical depression 随意等同。
...
> **适用**：B 档；动词且形态值得单独记住时写 `[态]`

**resent**
英/美 /rɪˈzent/
v. 愤恨，怨恨
> 多指长期关系中的不满；略正式
[义] To feel bitterness or indignation at a circumstance, action, or person—especially when you believe you have been treated unfairly. 核心义：对不公、冒犯或负担**愤愤不平**，常闷在心里、不直接爆发。不是暴怒（rage），多见于同事、配偶、手足等长期关系。
[态] resent → resented / resented / resenting；第三人称单数 resents
